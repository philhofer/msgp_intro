...
func TestPrimitiveMarshalUnmarshal(t *testing.T) {
	v := new(Primitive)
...
func BenchmarkPrimitiveMarshalMsg(b *testing.B) {
	v := new(Primitive)
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkPrimitiveAppendMsg(b *testing.B) {
	v := new(Primitive)
...
func BenchmarkPrimitiveUnmarshal(b *testing.B) {
	v := new(Primitive)
